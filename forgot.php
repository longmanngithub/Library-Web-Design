            ...
            <div class="row row border rounded-5 p-3 bg-white shadow box-area">
                ...
                <div class="col-md-6 right-box">
                    <div class="row align-items-center">
                        ...
                        <form action="forgot-code.php" method="post" class="needs-validation" novalidate id="forgot-form">
                            <!-- EMAIL -->
                            ...
                            <div class="input-group">
                                <button type="submit" class="btn btn-lg btn-primary w-100 fs-6 animation" id="submit-btn">Send verification code</button>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="modal-content rounded-4 shadow">
                ...
                <div class="modal-body py-0">
                    ...
                    <div class="success-message text-center">
                        <h4>Verification code sent successfully</h4>
                        <p>Check your <strong>email</strong> to retrieve the code.</p>
                    </div>
                </div>
                <a class="modal-footer flex-column align-items-stretch w-100 gap-2 pb-3 border-top-0" href="forgot-code.php" style="text-decoration: none;">
                    <button type="button" class="btn btn-lg btn-primary" data-bs-dismiss="modal">Dismiss</button>
                </a>
            </div>
        </div>
    </div>
