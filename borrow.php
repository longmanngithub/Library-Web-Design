...
<head>
    ...
    <title>Borrow Request | Library</title>
    ...
    <main id="borrow-page">
      ...
      <div class="container border rounded-4 shadow mb-5">
        ...
        <div class="room-content p-4">
            ...
            <h3 class="fw-bold" style="color: var(--main-color);">Borrow Request</h3>
                ...
                <div class="col-md-12 shadow border rounded-4" id="borrow-book-1">
                    <div class="row p-3">
                        ...
                        <div class="col-xl-10 col-lg-9 col-md-8 px-4 py-2">
                            ...
                            <p class="text-secondary">Borrowed date: August 5, 2024
                                <br>
                                Deadline: No deadline
                            </p>
                            <a href="#">
                              <button class="btn btn-primary animation" href="#"> Cancel </button>
                            </a>
                        </div>
                    </div>
                    <!-- /Row -->
